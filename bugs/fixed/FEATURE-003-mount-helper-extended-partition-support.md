...
**Note:** Copy stage encounters unrelated worker interrupt issue (not mount-helper related). Mount-helper functionality is complete and verified working.
